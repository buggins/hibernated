...
public:
     ...
     *
     * Parameters:
     *    con = A MySQLNConnection via which the packets are read
     *    fieldCount = the number of fields/columns generated by the query
     */
    this(MySQLNConnection con, uint fieldCount)
    {
...
public:
    this(MySQLNConnection con, ushort cols, ushort params)
    {
        _con = con;
        _colCount = cols;
        _paramCount = params;
 ...
 *
 * The MySQLNConnection is responsible for handshaking with the server to establish authentication.
 ...
 * number. MySQLNConnection deals with the headers and ensures that packet numbers are sequential.
 *
...
public:
     ...
     * its inherent type information. If this were the case, then the bool array could disappear.
     */
    this(MySQLNConnection con, ref ubyte[] packet, ResultSetHeaders rh, bool binary)
    in
    {
...
public:
     ...
     */
    this(MySQLNConnection con, string sql)
    {
        _sql = sql;
        this(con);
    }
